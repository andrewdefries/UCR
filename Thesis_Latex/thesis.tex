...
\title{Chemical Genetics With a Synthesized Bioactive Small Molecule Library of Drug-Like Terminal Acetylenes in {\it Arabidopsis thaliana}}

\author{Andrew Joseph Defries}
\degreemonth{August}
\degreeyear{2013}
\degree{Doctor of Philosophy}
\chair{Professor Julia Bailey-Serres}
\chairtwo{Professor Michael Pirrung}
\othermembers{Professor Jason Stajich}
\numberofmembers{3}
\field{Plant Biology}
\campus{Riverside}
...
I am grateful to my partner Anna Maria Huerta. Without you I would not have made it through the folds.
...
{\large
\begin{center}
To the Mind's Eye we call Imagination.
\end{center}}
\vfil\null
\end{dedication}
...
\input{chapter2} %Organic Synthesis
\input{chapter3} %Chemical genetic screen
\input{chapter4} %Phenotypes of Bioactives
\input{chapter5} %Target identification efforts with EMS
\input{chapter6} %Target identification via covalent capture
%%%%\input{conclusions}
